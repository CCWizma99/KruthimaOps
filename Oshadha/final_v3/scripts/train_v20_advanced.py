...
if os.path.exists("submissions/submission_v19.csv"):
    sub_v19 = pd.read_csv("submissions/submission_v19.csv")
    ...
    print("   [WARNING] submission_v19.csv not found. Skipping pseudo-labeling.")
    train_df['is_pseudo'] = 0
    test_df['is_pseudo'] = 0
