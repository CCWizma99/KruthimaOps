...
# Hand-calculated metrics for v3, v10, and v11 (from reports and historical records)
data = {
    "v3": (0.179622, 0.235205, 0.028892, 0.38559),
    "v10": (0.179040, 0.234760, 0.032580, 0.38598),
...
# Let's perform fitting on all 15 data points
print("\n" + "=" * 60)
