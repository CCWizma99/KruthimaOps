...
print("=" * 75)
print("  ML OPSIDIAN v703 - v70 + VALUE FREQUENCY COUNT FEATURES")
print("=" * 75)
...
print("\n" + "=" * 75)
print(f"  5-FOLD SPATIAL GROUP CV - MULTI-SEED v703 PIPELINE")
print("=" * 75)
...
print("\n" + "=" * 75)
print("  GLOBAL OOF RESULTS (v703 - v70 + Freq Count Features)")
print("=" * 75)
print(f"    [ALL ROWS]")
...
fold_report.to_csv("fold_report_v703.csv", index=False)
fold_report.to_csv("submissions/fold_report_v703.csv", index=False)
...
submission.to_csv("submission_v703.csv", index=False)
submission.to_csv("submissions/submission_v703.csv", index=False)
print(f"[DONE] Saved submission_v703.csv ({len(submission)} rows)")

np.save("oof_v703.npy", all_oof_stacked)
np.save("submissions/oof_v703.npy", all_oof_stacked)
print(f"[DONE] Saved oof_v703.npy")

# -----------------------------------------------------------------
# 8. POST-HOC POWER TRANSFORMATION OPTIMIZATION
# -----------------------------------------------------------------
print("\n" + "=" * 75)
print("  POST-HOC POWER TRANSFORMATION OPTIMIZATION (v703)")
print("=" * 75)
...
np.save("oof_v703_optimized.npy", opt_oof)
np.save("submissions/oof_v703_optimized.npy", opt_oof)
print(f"[DONE] Saved oof_v703_optimized.npy")
...
submission_opt.to_csv("submission_v703_optimized.csv", index=False)
submission_opt.to_csv("submissions/submission_v703_optimized.csv", index=False)
print(f"[DONE] Saved submission_v703_optimized.csv ({len(submission_opt)} rows)")
