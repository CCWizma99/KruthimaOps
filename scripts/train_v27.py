"""
ML Opsidian: Genesis v27 - Dampened Newton Optimization
========================================================================
...
7. Unconstrained Ridge Level-2 stacker (Negative Bias Corrector)
"""
...
# -----------------------------------------------------------------
print("=" * 70)
print("  ML OPSIDIAN v27 - DAMPENED NEWTON OPTIMIZATION")
print("=" * 70)
print("\n[LOAD] Loading data...")
...
print("\n" + "=" * 70)
print("  GLOBAL MULTI-SEED RESULTS (v27 - Dampened Newton Optimization)")
print("=" * 70)
...
fold_report.to_csv("submissions/fold_report_v27.csv", index=False)
print(f"\n[DONE] Saved fold_report_v27.csv")
...
submission.to_csv("submissions/submission_v27.csv", index=False)
print(f"[DONE] Saved submission_v27.csv ({len(submission)} rows)")

np.save("submissions/oof_v27.npy", oof_predictions_accum)
print(f"[DONE] Saved oof_v27.npy (for evaluate.py)")
