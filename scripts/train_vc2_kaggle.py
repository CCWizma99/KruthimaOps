...
==================================================================================
Features of vc2:
1. Multi-Seed Ensembling: SEEDS = [42, 2024] (inheriting the best LB baseline v67/v70 configuration)
...
print("=" * 75)
print("  ML OPSIDIAN vc2 - CRAZY 02 PIPELINE (2-SEED BEST LB INHERITED)")
print("=" * 75)
