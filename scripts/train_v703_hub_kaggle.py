"""
ML Opsidian: Genesis v703_hub - v703 with CAT-RMSE replaced by CAT-HUBER
==================================================================================
Base: v703 (6-Model, 3-Seed, Value Frequency Counts, Target Denoising, Dirty Imputation)
Exactly 1 change vs v703:
  - Swaps CAT-RMSE (d5) for CAT-HUB (d6) with Huber loss (delta=0.05).
"""
...
print("=" * 75)
print("  ML OPSIDIAN v703_hub - v703 + CAT-HUBER (3 SEEDS)")
print("=" * 75)
...
print("\n" + "=" * 75)
print(f"  5-FOLD SPATIAL GROUP CV - MULTI-SEED v703_hub PIPELINE")
print("=" * 75)
...
print("\n" + "=" * 75)
print("  GLOBAL OOF RESULTS (v703_hub - v703 with CAT-HUBER)")
print("=" * 75)
print(f"    [ALL ROWS]")
...
fold_report.to_csv("fold_report_v703_hub.csv", index=False)
fold_report.to_csv("submissions/fold_report_v703_hub.csv", index=False)
...
submission.to_csv("submission_v703_hub.csv", index=False)
submission.to_csv("submissions/submission_v703_hub.csv", index=False)
print(f"[DONE] Saved submission_v703_hub.csv ({len(submission)} rows)")

np.save("oof_v703_hub.npy", all_oof_stacked)
np.save("submissions/oof_v703_hub.npy", all_oof_stacked)
print(f"[DONE] Saved oof_v703_hub.npy")

# -----------------------------------------------------------------
# 8. POST-HOC POWER TRANSFORMATION OPTIMIZATION
# -----------------------------------------------------------------
print("\n" + "=" * 75)
print("  POST-HOC POWER TRANSFORMATION OPTIMIZATION (v703_hub)")
print("=" * 75)
...
np.save("oof_v703_hub_optimized.npy", opt_oof)
np.save("submissions/oof_v703_hub_optimized.npy", opt_oof)
print(f"[DONE] Saved oof_v703_hub_optimized.npy")
...
submission_opt.to_csv("submission_v703_hub_optimized.csv", index=False)
submission_opt.to_csv("submissions/submission_v703_hub_optimized.csv", index=False)
print(f"[DONE] Saved submission_v703_hub_optimized.csv ({len(submission_opt)} rows)")
