...
print("=" * 75)
print("  ML OPSIDIAN v1200 - ADVERSARIAL SHIFT DROPS")
print("=" * 75)
...
print("\n" + "=" * 75)
print(f"  5-FOLD SPATIAL GROUP CV - SINGLE-SEED v1200 PIPELINE")
print("=" * 75)
...
print("\n" + "=" * 75)
print("  GLOBAL OOF RESULTS (v1200 - Adversarial Shift Drops)")
print("=" * 75)
print(f"    [ALL ROWS]")
...
fold_report.to_csv("fold_report_v1200.csv", index=False)
fold_report.to_csv("submissions/fold_report_v1200.csv", index=False)
...
submission.to_csv("submission_v1200.csv", index=False)
submission.to_csv("submissions/submission_v1200.csv", index=False)
print(f"[DONE] Saved submission_v1200.csv ({len(submission)} rows)")

np.save("oof_v1200.npy", all_oof_stacked)
np.save("submissions/oof_v1200.npy", all_oof_stacked)
print(f"[DONE] Saved oof_v1200.npy")

# -----------------------------------------------------------------
# 8. POST-HOC POWER TRANSFORMATION OPTIMIZATION
# -----------------------------------------------------------------
print("\n" + "=" * 75)
print("  POST-HOC POWER TRANSFORMATION OPTIMIZATION (v1200)")
print("=" * 75)
...
np.save("oof_v1200_optimized.npy", opt_oof)
np.save("submissions/oof_v1200_optimized.npy", opt_oof)
print(f"[DONE] Saved oof_v1200_optimized.npy")
...
submission_opt.to_csv("submission_v1200_optimized.csv", index=False)
submission_opt.to_csv("submissions/submission_v1200_optimized.csv", index=False)
print(f"[DONE] Saved submission_v1200_optimized.csv ({len(submission_opt)} rows)")
