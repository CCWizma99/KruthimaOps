"""
ML Opsidian: Genesis v70 - 3-Seed & Conflict-Resolved Stacking Pipeline
==================================================================================
Features of v70:
Inherits v67 (Breakthrough Spatial Stacking & Pseudo-Labeling Pipeline) with:
1. 3-Seed Ensembling: SEEDS = [42, 2024, 7] to further reduce variance.
...
print("=" * 75)
print("  ML OPSIDIAN v70 - 3-SEED & CONFLICT-RESOLVED PIPELINE")
print("=" * 75)
...
print("\n" + "=" * 75)
print(f"  5-FOLD SPATIAL GROUP CV - MULTI-SEED v70 PIPELINE")
print("=" * 75)
...
print("\n" + "=" * 75)
print("  GLOBAL OOF RESULTS (v70 - Raw Custom Stacking)")
print("=" * 75)
print(f"    [ALL ROWS]")
...
fold_report.to_csv("fold_report_v70.csv", index=False)
fold_report.to_csv("submissions/fold_report_v70.csv", index=False)
...
submission.to_csv("submissions/submission_v70.csv", index=False)
print(f"[DONE] Saved submission_v70.csv ({len(submission)} rows)")

np.save("oof_v70.npy", all_oof_stacked)
np.save("submissions/oof_v70.npy", all_oof_stacked)
print(f"[DONE] Saved oof_v70.npy")

# -----------------------------------------------------------------
# 8. INTEGRATED POST-HOC POWER TRANSFORMATION OPTIMIZATION
# -----------------------------------------------------------------
print("\n" + "=" * 75)
print("  POST-HOC POWER TRANSFORMATION OPTIMIZATION (v70)")
print("=" * 75)
...
np.save("oof_v70_optimized.npy", opt_oof)
np.save("submissions/oof_v70_optimized.npy", opt_oof)
print(f"[DONE] Saved oof_v70_optimized.npy")
...
submission_opt.to_csv("submission_v70_optimized.csv", index=False)
submission_opt.to_csv("submissions/submission_v70_optimized.csv", index=False)
print(f"[DONE] Saved submission_v70_optimized.csv ({len(submission_opt)} rows)")
