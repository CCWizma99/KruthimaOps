"""
ML Opsidian: Genesis v710 - Robust Customized Imputation + Adversarial Drop + 5 Seeds
==================================================================================
...
print("=" * 75)
print("  ML OPSIDIAN v710 - CUSTOMIZED IMPUTATION + ADVERSARIAL DROP")
print("=" * 75)
...
print("\n" + "=" * 75)
print(f"  5-FOLD SPATIAL GROUP CV - MULTI-SEED v710 PIPELINE")
print("=" * 75)
...
print("\n" + "=" * 75)
print("  GLOBAL OOF RESULTS (v710 - Customized Imputation)")
print("=" * 75)
print(f"    [ALL ROWS]")
...
fold_report.to_csv("fold_report_v710.csv", index=False)
fold_report.to_csv("submissions/fold_report_v710.csv", index=False)
...
submission.to_csv("submission_v710.csv", index=False)
submission.to_csv("submissions/submission_v710.csv", index=False)
print(f"[DONE] Saved submission_v710.csv ({len(submission)} rows)")

np.save("oof_v710.npy", all_oof_stacked)
np.save("submissions/oof_v710.npy", all_oof_stacked)
print(f"[DONE] Saved oof_v710.npy")

# -----------------------------------------------------------------
# 8. POST-HOC POWER TRANSFORMATION OPTIMIZATION
# -----------------------------------------------------------------
print("\n" + "=" * 75)
print("  POST-HOC POWER TRANSFORMATION OPTIMIZATION (v710)")
print("=" * 75)
...
np.save("oof_v710_optimized.npy", opt_oof)
np.save("submissions/oof_v710_optimized.npy", opt_oof)
print(f"[DONE] Saved oof_v710_optimized.npy")
...
submission_opt.to_csv("submission_v710_optimized.csv", index=False)
submission_opt.to_csv("submissions/submission_v710_optimized.csv", index=False)
print(f"[DONE] Saved submission_v710_optimized.csv ({len(submission_opt)} rows)")
