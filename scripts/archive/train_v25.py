"""
ML Opsidian: Genesis v25 - Pure Statistical Foundation
========================================================================
...
# -----------------------------------------------------------------
print("=" * 70)
print("  ML OPSIDIAN v25 - PURE STATISTICAL FOUNDATION")
print("=" * 70)
print("\n[LOAD] Loading data...")
...
print("\n" + "=" * 70)
print("  GLOBAL MULTI-SEED RESULTS (v25 - Pure Statistical Foundation)")
print("=" * 70)
...
fold_report.to_csv("submissions/fold_report_v25.csv", index=False)
print(f"\n[DONE] Saved fold_report_v25.csv")
...
submission.to_csv("submissions/submission_v25.csv", index=False)
print(f"[DONE] Saved submission_v25.csv ({len(submission)} rows)")

np.save("submissions/oof_v25.npy", oof_predictions_accum)
print(f"[DONE] Saved oof_v25.npy (for evaluate.py)")
