"""
ML Opsidian: Genesis v706 - stable stacker, 5 seeds, and Kaggle tabular hacks
==================================================================================
...
print("=" * 75)
print("  ML OPSIDIAN v706 - STABLE STACKER + 5 SEEDS + TABULAR HACKS")
print("=" * 75)
...
fold_report.to_csv("fold_report_v706.csv", index=False)
fold_report.to_csv("submissions/fold_report_v706.csv", index=False)
...
submission.to_csv("submission_v706.csv", index=False)
submission.to_csv("submissions/submission_v706.csv", index=False)
print(f"[DONE] Saved submission_v706.csv ({len(submission)} rows)")

np.save("oof_v706.npy", all_oof_stacked)
np.save("submissions/oof_v706.npy", all_oof_stacked)
print(f"[DONE] Saved oof_v706.npy")

# -----------------------------------------------------------------
# 8. POST-HOC POWER TRANSFORMATION OPTIMIZATION
# -----------------------------------------------------------------
print("\n" + "=" * 75)
print("  POST-HOC POWER TRANSFORMATION OPTIMIZATION (v706)")
print("=" * 75)
...
np.save("oof_v706_optimized.npy", opt_oof)
np.save("submissions/oof_v706_optimized.npy", opt_oof)
print(f"[DONE] Saved oof_v706_optimized.npy")
...
submission_opt.to_csv("submission_v706_optimized.csv", index=False)
submission_opt.to_csv("submissions/submission_v706_optimized.csv", index=False)
print(f"[DONE] Saved submission_v706_optimized.csv ({len(submission_opt)} rows)")
