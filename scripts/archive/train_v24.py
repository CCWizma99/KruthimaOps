...
fold_report.to_csv("submissions/fold_report_v24.csv", index=False)
...
submission.to_csv("submissions/submission_v24.csv", index=False)
print(f"[DONE] Saved submission_v24.csv ({len(submission)} rows)")

np.save("submissions/oof_v24.npy", oof_predictions_accum[real_mask])
