...
print("=" * 75)
print("  ML OPSIDIAN vmav2 - vmal + ADVERSARIAL DROP v2 (8 FEATURES)")
print("=" * 75)
...
print("\n" + "=" * 75)
print(f"  5-FOLD SPATIAL GROUP CV - MULTI-SEED vmav2 PIPELINE")
print("=" * 75)
...
print("\n" + "=" * 75)
print("  GLOBAL OOF RESULTS (vmav2 - Adversarial Drop v2)")
print("=" * 75)
print(f"    [ALL ROWS]")
...
fold_report.to_csv("fold_report_vmav2.csv", index=False)
fold_report.to_csv("submissions/fold_report_vmav2.csv", index=False)
...
submission.to_csv("submission_vmav2.csv", index=False)
submission.to_csv("submissions/submission_vmav2.csv", index=False)
print(f"[DONE] Saved submission_vmav2.csv ({len(submission)} rows)")

np.save("oof_vmav2.npy", all_oof_stacked)
np.save("submissions/oof_vmav2.npy", all_oof_stacked)
print(f"[DONE] Saved oof_vmav2.npy")

# -----------------------------------------------------------------
# 8. POST-HOC POWER TRANSFORMATION OPTIMIZATION
# -----------------------------------------------------------------
print("\n" + "=" * 75)
print("  POST-HOC POWER TRANSFORMATION OPTIMIZATION (vmav2)")
print("=" * 75)
...
np.save("oof_vmav2_optimized.npy", opt_oof)
np.save("submissions/oof_vmav2_optimized.npy", opt_oof)
print(f"[DONE] Saved oof_vmav2_optimized.npy")
...
submission_opt.to_csv("submission_vmav2_optimized.csv", index=False)
submission_opt.to_csv("submissions/submission_vmav2_optimized.csv", index=False)
print(f"[DONE] Saved submission_vmav2_optimized.csv ({len(submission_opt)} rows)")
